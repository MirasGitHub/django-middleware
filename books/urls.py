...
from .views import (BookListView, BookCreateView, BookDetailView, BookDeleteView, BookUpdateView, AuthorDeleteView, 
                    AuthorListView, AuthorCreateView, AuthorDetailView, AuthorUpdateView)
